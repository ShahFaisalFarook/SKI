  ...
  return (
    <div className="relative">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-hidden shadow-2xl"
      >
          ...
          <div className="hidden md:flex items-center justify-between h-16">
            ...
            >
              ...
              >
                <motion.div
                  ...
                  className="bg-gradient-to-br from-orange-500 to-orange-600 p-2.5 rounded-xl shadow-lg group-hover:shadow-orange-500/50 transition-all"
                >
              ...
              >
                <motion.div
                  whileHover={{ rotate: 15, scale: 1.1 }}
                  className="bg-gradient-to-br from-blue-500 to-blue-600 p-2.5 rounded-xl shadow-lg group-hover:shadow-blue-500/50 transition-all"
                >
              ...
              >
                <motion.div
                  whileHover={{ rotate: 15, scale: 1.1 }}
                  className="bg-gradient-to-br from-green-500 to-green-600 p-2.5 rounded-xl shadow-lg group-hover:shadow-green-500/50 transition-all"
                >
            ...
            >
              ...
              {socialLinks.map((social, index) => (
                ...
                >
                  <motion.div
                    className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 hover:border-white/40 transition-all"
                    whileHover={{
          ...
          <div className="md:hidden py-3 space-y-3">
            ...
            >
              ...
              >
                <motion.div
                  whileHover={{ rotate: 15 }}
                  className="bg-gradient-to-br from-blue-500 to-blue-600 p-2 rounded-lg shadow-lg"
                >
                  <Mail className="w-4 h-4" />
                </motion.div>
            ...
            <motion.button
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.6 }}
              className="w-full bg-gradient-to-r from-orange-500 via-orange-600 to-orange-500 hover:from-orange-600 hover:via-orange-700 hover:to-orange-600 px-4 py-3 rounded-xl shadow-lg hover:shadow-orange-500/50 transition-all flex items-center justify-between group"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="flex items-center space-x-2">
                <div className="flex -space-x-2">
                  {socialLinks.slice(0, 3).map((social, idx) => (
                    <div
                      key={idx}
                      className="w-7 h-7 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center border-2 border-orange-600"
                    >
                      <social.icon className="w-3.5 h-3.5" />
                    </div>
                  ))}
                </div>
                <span className="text-sm font-bold">Social Media & Location</span>
              </div>
              <motion.div
        ...
        {isSocialDropdownOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-4 left-4 right-4 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl shadow-2xl border border-white/10 overflow-hidden z-50 max-w-md mx-auto"
            >
              {/* Header */}
