  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`fixed left-0 right-0 z-40 transition-all duration-300 bg-slate-900/98 backdrop-blur-xl shadow-2xl border-b border-white/10 ${
          isScrolled ? 'top-[56px] md:top-14' : 'top-[140px] md:top-14'
        }`}
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex justify-between items-center h-14 lg:h-16">
            ...
            >
              ...
              >
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-orange-500/30 to-yellow-500/30 rounded-lg blur-sm"
                  animate={{
                    scale: [1, 1.15, 1],
                    opacity: [0.4, 0.7, 0.4]
                  }}
                ...
                <img 
                  ...
                  className="relative h-9 w-9 lg:h-11 lg:w-11 object-contain rounded-lg shadow-lg group-hover:shadow-orange-500/50 transition-shadow"
                />
              </motion.div>
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-[10px] lg:text-xs text-orange-400 font-medium flex items-center gap-1">
                  <Sun className="w-2.5 h-2.5 lg:w-3 lg:h-3" />
                  PM Surya Ghar
                </p>
              </div>
            </motion.a>
            ...
            <div className="hidden lg:flex items-center space-x-1">
              {navLinks.map((link, idx) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-2.5 py-2 rounded-lg font-semibold text-gray-300 hover:text-white hover:bg-white/10 transition-all text-sm"
                >
                  {link.name}
                </motion.a>
              ))}
              ...
              >
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full blur-sm"
                  animate={{
                    opacity: [0.5, 0.9, 0.5],
                    scale: [1, 1.08, 1]
                  }}
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.08 }}
                whileTap={{ scale: 0.95 }}
                className="ml-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-full font-bold shadow-lg shadow-blue-500/40 hover:shadow-blue-500/60 transition-all flex items-center space-x-1.5 text-sm"
              >
            ...
            <div className="lg:hidden flex items-center space-x-2">
              ...
              >
                ...
                />
                <div className="relative bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-2 rounded-full shadow-lg">
                  <Gift className="w-4 h-4" />
                </div>
              </motion.a>
              ...
              <motion.button
                ...
                className="relative w-10 h-10 flex items-center justify-center bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 hover:border-orange-500/50 transition-colors"
              >
                <div className="relative w-5 h-5">
                  <motion.span
                    animate={isMobileMenuOpen ? { rotate: 45, y: 6 } : { rotate: 0, y: 0 }}
                    className={`absolute w-5 h-0.5 rounded-full left-0 top-0.5 transition-colors ${
                      isMobileMenuOpen ? 'bg-orange-500' : 'bg-white'
                    }`}
                  />
                  <motion.span
                  ...
                  <motion.span
                    animate={isMobileMenuOpen ? { rotate: -45, y: -6 } : { rotate: 0, y: 0 }}
                    className={`absolute w-5 h-0.5 rounded-full left-0 bottom-0.5 transition-colors ${
                      isMobileMenuOpen ? 'bg-orange-500' : 'bg-white'
                    }`}
                  />
                </div>
          ...
          <>
            ...
            <motion.div
              ...
              className={`fixed right-0 bottom-0 w-full sm:w-80 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 z-[36] lg:hidden overflow-y-auto ${
                isScrolled ? 'top-[110px] md:top-[112px]' : 'top-[196px] md:top-[112px]'
              }`}
            >
              {/* Header */}
              ...
              <div className="p-4 space-y-2.5 bg-slate-950/50">
                ...
                >
                  <motion.div 
                    className="absolute inset-0 bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 rounded-xl blur-sm"
                    animate={{
                      opacity: [0.6, 1, 0.6],
                    }}
                    transition={{
